      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          ...
          <div className="col-span-1 md:col-span-4 reveal-on-scroll delay-200">
            ...
            <div className="space-y-8">
              <div className="flex gap-8">
                <Link className="nav-link text-on-surface-variant hover:text-primary transition-colors flex items-center gap-2 group/social" href="https://www.instagram.com/bartolo.cafe/?hl=es" target="_blank" rel="noopener noreferrer">
                  <FontAwesomeIcon icon={faInstagram} className="text-[20px] group-hover/social:scale-110 transition-transform" />
                  Instagram
                </Link>
                <Link className="nav-link text-on-surface-variant hover:text-primary transition-colors flex items-center gap-2 group/social" href="https://www.facebook.com/p/Bartolo-Caf%C3%A9-100063752944807/?locale=es_LA" target="_blank" rel="noopener noreferrer">
              ...
              <div className="font-body-md text-on-surface-variant">
                <p className="mb-2">hola@bartolocafe.com</p>
                <p>+54 2302 342711</p>
              </div>
            </div>
          </div>
        ...
        <div className="pt-12 border-t border-primary/10 flex flex-col md:flex-row justify-between items-center gap-6 reveal-on-scroll delay-300">
          <p className="font-body-md text-on-surface-variant/60 text-center md:text-left">
            © 2026 Bartolo café. Todos los derechos reservados. <span className="hidden md:inline">|</span><br className="md:hidden" /> Desarrollado por Xanti Baras
          </p>
